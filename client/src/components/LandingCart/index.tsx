  ...
  switch (type) {
    case 'first':
      data = {
        ...
        img: mainImage,
        styles:
          'relative w-full self-start flex lg:flex-row flex-col justify-between lg:pt-20 lg:pb-2 pt-12 gap-16 text-blue-dark',
        description:
    ...
    case 'second':
      data = {
        ...
        img: frameImage,
        styles:
          'relative w-full self-start flex lg:flex-row lg:flex-row-reverse  flex-col justify-between lg:pt-10 pt-12 gap-24 text-blue-dark pb-20 bt-20',
    ...
    case 'third':
      data = {
        ...
        img: computerImage,
        styles:
          'relative w-full self-start lg:flex-row flex-col flex justify-between lg:pt-10 pt-12 gap-16 pb-20 bt-20 text-blue-dark',
        description:
